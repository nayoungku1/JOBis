...
def extract_relevant_info(document_text, link_info):
    """
    Extract relevant information from document text and links using gpt-4o-mini.
    Args:
    ...
    prompt = ChatPromptTemplate.from_template(
        """
        You are an expert in extracting relevant information from individual's resumes, CVs, cover letters, and online profiles (GitHub, LinkedIn, etc.). 
        Your task is to extract information that is EXPLICITLY mentioned in the provided document text and link information, combining them into a single output with minimal duplication. 
        Under NO circumstances should you infer, assume, or generate information that is not explicitly stated. 
        ...
        - For GitHub, include repository names and descriptions as projects if relevant.
        - For LinkedIn, include profile details (e.g., name, job title) and any mentioned posts or reposts.
        ...
        - Example:
          ...
          Link Information: "GitHub Repository: AI Chatbot - Python-based chatbot, LinkedIn Profile: Nayoung Ku - Software Engineer"
          Output:
          ```markdown
          # Extracted Resume Information
          ...
          ## Online Profiles
          - GitHub: https://github.com/nayoung-ku
          - LinkedIn: Nayoung Ku - Software Engineer
